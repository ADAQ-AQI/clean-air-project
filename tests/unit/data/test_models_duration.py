...
from clean_air.data.models import Duration


class InitTest(unittest.TestCase):
    "Testing initial arguments are treated correctly"

    def test_init_defaults(self):
        """
        GIVEN no arguments are passed 
        WHEN a Duration is created 
        THEN values default to 0
        """
    ...
    def test_init_kwargs_ints(self):
        """
        WHEN a Duration is created using keyword arguments and integer values 
    ...
    def test_init_kwargs_floats(self):
        """
        WHEN a Duration is created using keyword arguments and float values 
        THEN the correct values are stored
        """
    ...
    def test_init_positionals_ints(self):
        """
        WHEN a Duration is created using positional arguments and integer values 
        THEN the correct values are stored
        """
    ...
    def test_init_positionals_floats(self):
        """
        WHEN a Duration is created using positional arguments and float values 
        THEN the correct values are stored
        """
    ...
    def test_init_weeks_int(self):
        ...
        GIVEN weeks=1 
        WHEN a Duration is created 
        THEN correct values are stored
        """
        d = Duration(weeks=1)
...
class TestOperations:
    "Testing operations (addition and subtraction)"
    ...
    def test_duration__add__(self, left_operand, right_operand, expected_result):
        """
        GIVEN operands A and B 
    ...
    def test_duration__radd__(self, left_operand, right_operand, expected_result):
        """
        GIVEN operands A and B 
    ...
    def test_duration__sub__(self, left_operand, right_operand, expected_result):
        """
        GIVEN operands A and B 
    ...
    @pytest.mark.parametrize(
        ...
        ids=repr)
    def test_duration__rsub__(self, left_operand, right_operand, expected_result):
        """
        GIVEN operands A and B 
        WHEN B is subtracted from A 
        THEN the expected result is returned.
    ...
    def test_duration_invalid_subtractions(self, left_operand, right_operand):
        """
        GIVEN operands A and B 
        WHEN B is subtracted from A 
...
class TestErrors:
    "Testing errors that don't fit in other categories"

    @pytest.mark.parametrize("attr_name", ["seconds", "minutes", "hours", "days", "months", "years", "weeks"])
    def test_duration_attrs_read_only(self, attr_name):
    ...
    def test_duration_init_weeks_mutually_exclusive(self, incompatible_kwarg):
        """
...
class TestConversions:
    "Testing conversions between durations/strings/deltas etc"
    ...
    def test_duration_normalized(self, dur: Duration, expected: Duration):
    ...
    def test_duration_parse_str_valid(self, dur_obj: Duration, str_dur: str):
        """Can we convert a valid ISO8601 duration string to a Duration object?"""
        assert Duration.parse_str(str_dur) == dur_obj

    @pytest.mark.parametrize("dur_obj,str_dur", DURATION_STR_CONVERSION_TEST_CASES)
    def test_duration_str_valid(self, dur_obj: Duration, str_dur: str):
    ...
    def test_duration_str_conversion_invalid(self, invalid_str_dur: str):
        """
        GIVEN an invalid string 
        WHEN converting the string to a Duration object is attempted 
        THEN a ValueError is raised
        """
    ...
    def test_duration_to_timedelta(self, dur: Duration, expected_td: timedelta):
        """
        GIVEN a Duration 
        WHEN Duration.to_timedelta is called 
        THEN the equivalent timedelta is returned
        """
    ...
    def test_duration_from_timedelta(self, td, expected_dur):
        """
        GIVEN a timedelta 
        WHEN Duration.from_timedelta is called 
        THEN the equivalent Duration is returned
        """
    ...
    def test_duration_to_relativedelta(self, dur: Duration, expected_rd: relativedelta):
        """
        GIVEN a Duration 
        WHEN Duration.to_relativedelta is called 
        THEN the equivalent relativedelta is returned
        """
    ...
    def test_duration_from_relativedelta(self, rd: relativedelta, expected_dur: Duration):
        """
        GIVEN a relativedelta 
        WHEN Duration.from_relativedelta is called 
        THEN the equivalent Duration is returned
        """
